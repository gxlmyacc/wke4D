...
WKE_API bool WKE_CALL wkeEditorCanCopy(wkeWebView webView);
WKE_API void WKE_CALL wkeEditorCopy(wkeWebView webView);
WKE_API bool WKE_CALL wkeEditorCanCut(wkeWebView webView);
WKE_API void WKE_CALL wkeEditorCut(wkeWebView webView);
WKE_API bool WKE_CALL wkeEditorCanPaste(wkeWebView webView);
WKE_API void WKE_CALL wkeEditorPaste(wkeWebView webView);
WKE_API bool WKE_CALL wkeEditorCanDelete(wkeWebView webView);
WKE_API void WKE_CALL wkeEditorDelete(wkeWebView webView);
WKE_API bool WKE_CALL wkeEditorCanUndo(wkeWebView webView);
WKE_API void WKE_CALL wkeEditorUndo(wkeWebView webView);
WKE_API bool WKE_CALL wkeEditorCanRedo(wkeWebView webView);
WKE_API void WKE_CALL wkeEditorRedo(wkeWebView webView);
...
WKE_API const void* wkeGetUserData(wkeWebView webView);
WKE_API void wkeSetUserData(wkeWebView webView, void* userData);
